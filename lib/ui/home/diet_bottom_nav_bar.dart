...
class DietBottomNavBar extends StatefulWidget {
  final int currentPage;
  final ValueChanged<int> onChanged;

  const DietBottomNavBar({
    Key? key,
  ...
  @override
  _DietBottomNavBarState createState() => _DietBottomNavBarState();
}

class _DietBottomNavBarState extends State<DietBottomNavBar> {
